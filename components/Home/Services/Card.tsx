...
const Card: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className="main flex flex-col-reverse rounded-2xl bg-white p-4 sm:p-6 lg:flex-row lg:gap-8 lg:rounded-[60px] lg:p-16">
        <div className="flex flex-col gap-4 lg:w-[60%] lg:gap-6">
          ...
          <p className="text-base leading-relaxed sm:text-lg lg:text-xl">{description}</p>
